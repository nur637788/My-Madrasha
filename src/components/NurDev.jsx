...
function NurDev() {
  return (
    <div className='min-h-screen'>
      <div data-aos='zoom-in' className="mt-25 p-10 mb-10 max-w-xl m-auto border rounded-xl shadow-md shadow-blue-900  hover:shadow-lg transition ">
        <div className='w-50 h-50 m-auto ring-2 ring-green-300 rounded-full hover:scale-90 duration-300'>
          <img src="/image/NurDev-image.jpg" alt="NurDev-image" loading='lazy' className="w-full h-full  rounded-full" />
        </div>
