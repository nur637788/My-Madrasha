  ...
  return (
    <div data-aos='fade-down' className='fixed top-0 right-0 left-0 z-100  bg-gradient-to-l bg-pink-200 via-gray-100 from-pink-200 '>
      ...
      <div className='flex justify-between items-center px-4 py-2'>
        ...
        {/* Logo */}
        <img onClick={()=>navigate('/logo')} className='w-15 h-15 rounded-full' src="/image/logo.jpg" alt="Adatala Dakhil Madrasha Logo" />
        ...
        <div className=' '>
          <button onClick={()=>navigate('/getstart')} className='border border-blue-400 bg-blue-400 text-white py-1 px-2 rounded-lg hover:text-black hover:bg-blue-600 transition duration-300'>
