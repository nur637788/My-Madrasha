...
function TeacherDetails({ teacher, onClose }) {
    return (
        <div className="mt-16 fixed inset-0 bg-black bg-opacity-50 flex justify-center items-center z-50">
            <div className="bg-white font-semibold px-7 py-8 rounded-xl shadow-lg w-xl max-w-xl max-h-[90vh] overflow-y-auto relative">
                <button
                    onClick={onClose}
