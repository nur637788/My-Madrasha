...
<div data-aos='zoom-in' className='flex gap-4'>
  <button onClick={()=>navigate('/headmassage')} className="px-4 py-2 mt-5 bg-pink-500 hover:bg-pink-800 hover:font-bold hover:scale-95 text-white rounded-xl shadow-lg transition duration-300">
Massage of Head
</button>
<button onClick={()=>navigate('/sscresult')} className="px-4 py-2 mt-5 bg-pink-500 hover:bg-pink-800 hover:font-bold hover:scale-95 text-white rounded-xl shadow-lg transition duration-300">
More Details
</button>
</div>
