...
<div className="rounded-xl h-10 items-center px-2 inline-flex animate-marquee space-x-4 bg-gradient-to-l bg-amber-200 via-pink-400 from-blue-600 ">
...
<div className='flex gap-4'>
  <button onClick={()=>navigate('/headmassage')} className="px-4 py-2 mt-5 bg-pink-500 hover:bg-pink-800 hover:font-bold text-white rounded-xl shadow-lg transition duration-300">
Massage of Head
</button>
<button onClick={()=>navigate('/sscresult')} className="px-4 py-2 mt-5 bg-pink-500 hover:bg-pink-800 hover:font-bold text-white rounded-xl shadow-lg transition duration-300">
More Details
</button>
</div>
...
<img
src="/image/image.jpg"
alt="adatala dakhil madrasha"
className="relative border-8 border-blue-500 rounded-2xl shadow-xl hover:shadow-black h-60 w-full max-w-md object-cover"
/>
</div>
...
<div>
    ...
    <div>
        <div className='mx-5 my-10 max-w-full h-40 bg-blue-300 rounded-md m-auto'>
